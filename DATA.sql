...
(
	...
	--- 0 - Đang Kinh Kinh Doanh 1 - Ngừng Kinh Doanh 2 - Tạm Hết Hàng
...
(
	...
	CONSTRAINT FK_CHI_TIET_SAN_PHAM_ChatLieu FOREIGN KEY (IdChatLieu) REFERENCES DeGiay (ID),
)
...
INSERT INTO CHI_TIET_SAN_PHAM (IdSP, IdThuongHieu, IdMau, IdSize, IdDeGiay,IdChatLieu,MaCTSP, SoLuongTon, GiaNiemYet, GiaBan, MoTa, NgayTao, TrangThai)
VALUES 
...
--select * from HOADON
INSERT INTO HOADONCHITIET (IdHoaDon, IdCTSP,MaHoaDonCT, SoLuong, DonGia, ThanhTien,NgayTao, TrangThai)
VALUES 
(9, 2, 2, 1, 750000, 375000, GETDATE(), 1),
(10, 3, 2, 1, 750000, 375000, GETDATE(), 1),
(11, 4, 2, 1, 750000, 375000, GETDATE(), 1),
(12, 5, 2, 1, 750000, 375000, GETDATE(), 1),
(13, 6, 2, 1, 750000, 375000, GETDATE(), 1),
(14, 7, 2, 1, 750000, 375000, GETDATE(), 1)
