...
//        txtmadonvi.setEnabled(true);
    ...
    private boolean checknull() {
        ...
        try {
            gia = Integer.parseInt(txtGiaUpSize.getText());
            if (txtGiaUpSize.getText().trim().equals("")) {
                JOptionPane.showMessageDialog(this, "Không được bỏ trống giá");
                return true;
            } else if (gia < 0 || gia > 1000000) {
                JOptionPane.showMessageDialog(this, "Giá không được nhỏ hơn 0 và lớn hơn 1M");
                return true;
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Không được nhập giá là chữ");
            return true;
        }
        return false;
    }
