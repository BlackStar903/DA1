...
public class QuanLyBanHangJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pnHoadonLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnTaoDon, btnThanhToan});
        ...
        pnHoadonLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {btnTaoDon, btnThanhToan});
    ...
    private void tblHoadonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblHoadonMousePressed
        ...
        try {
            if (evt.getClickCount() == 2) {
                ...
                filltoTableHDCT();
                resettrue();
                String tongTienText = tblHoadon.getValueAt(row, 4).toString();
                for (char c : tongTienText.toCharArray()) {
                    tongTienText = tongTienText.replace(",", "");
                }
                Integer tongTien = Integer.parseInt(tongTienText);
...
//        contentPane.add(scrollPane);
    ...
    public int SanPhamGiamGia(String masp, int gia) {
        ...
        try {
            ...
            if ((datenow.before(datekt) && datenow.after(datebd) && gg.getTrangthai() == 1) || datenow.equals(datekt) || datenow.equals(datebd)) {
