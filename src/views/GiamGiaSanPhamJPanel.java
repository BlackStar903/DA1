...
//        fillcomboboxEvent();
    ...
    private void initComponents() {
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {btnSua, btnThem, btngiahan, jButton1});
                ...
                switch (cbohansukien.getSelectedItem().toString()) {
                    ...
                    case "không sử dụng":
                        if (g.getTrangthai() == 0) {
                            ...
                            model.addRow(new Object[]{g.getId_GiamGia(), g.getTenSK(),
                                ten, g.getNgayBD(), g.getNgayKT(),
                                g.getTrangthai() == 0 ? "Không sử dụng" : "Còn sử dụng"});
